...
string images_path = "C:/Users/23/Documents/TowerOfHanoi/images/";

MainWindow::MainWindow(QWidget *parent) :
    QMainWindow(parent), ui(new Ui::MainWindow) {
    ui->setupUi(this);
    setWindowTitle("Tower-of-hanoi");
    setFixedSize(1280, 720);
    setWindowFlags(Qt::CustomizeWindowHint | Qt::WindowSystemMenuHint  | Qt::WindowCloseButtonHint);

    first = -1;
    second = -1;
    OrderedData.push_back(images_path + "layer_4.png");
    OrderedData.push_back(images_path + "layer_3.png");
    OrderedData.push_back(images_path + "layer_2.png");
    OrderedData.push_back(images_path + "layer_1.png");
...
void MainWindow::on_action1_triggered() {
    ...
    B.clear();
    C.clear();
    A.push_back(images_path + "layer_4.png");
    Difficulty = 1;
    UpdateGUI();
}
...
void MainWindow::on_action2_triggered() {
    ...
    C.clear();
    A.push_back(images_path + "layer_4.png");
    A.push_back(images_path + "layer_3.png");
    Difficulty = 2;
    UpdateGUI();
}
...
void MainWindow::on_action3_triggered() {
    ...
    A.push_back(images_path + "layer_4.png");
    A.push_back(images_path + "layer_3.png");
    A.push_back(images_path + "layer_2.png");
    Difficulty = 3;
    UpdateGUI();
}
...
void MainWindow::on_action4_triggered() {
    ...
    A.push_back(images_path + "layer_3.png");
    A.push_back(images_path + "layer_2.png");
    A.push_back(images_path + "layer_1.png");
    Difficulty = 4;
    UpdateGUI();
}
